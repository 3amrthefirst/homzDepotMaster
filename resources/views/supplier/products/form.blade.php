...
@php
$recievedtime=['oneWeek'=>' 7 أيام عمل'
                ,'twoWeek'=>'10 أيام عمل'
                ,'byOrder'=>'بالطلب'];
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <span class="help-block">
                                    <strong style="color: rgb(151, 8, 8)">{{ $errors->first('discountValue') }}</strong>
                                </span>
            @endif
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                ...
                <span class="help-block">
                                    <strong style="color: rgb(151, 8, 8)">{{ $errors->first('discountPercent') }}</strong>
                                </span>
            @endif
            </div>
        </div>
