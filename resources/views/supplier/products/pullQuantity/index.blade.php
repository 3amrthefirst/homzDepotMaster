                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($records as $record)
                            ...
                            <tr id="removable{{$record->id}}">
                                ...
                                <td>{{$record->Pull_Quantity_Status}} </td>
                                ...
                                <td><a data-toggle="modal" data-target="#editQuantity{{$record->id}}" type="submit" class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>
                                    @include('supplier.products.pullQuantity.edit')
                                </td>                                
                                <td>
                                    <button
                                        id="{{$record->id}}"
                                        data-token="{{ csrf_token() }}"
                                        data-route="{{route('supplier.product.pullQuantity.destroy', $record->id)}}"
                                        type="button"
