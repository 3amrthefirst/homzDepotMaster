            ...
            <div class="table-responsive">
                ...
                <table class="table m-b-xs">
                    ...
                    <tr>
                        ...
                        <td>
                            {{__(' الكمية المراد سحبها')}} : <strong>{{$record->quantity}} </strong>
