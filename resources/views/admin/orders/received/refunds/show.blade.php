            ...
            <div class="table-responsive">
                <table class="table m-b-xs">
                    <tbody>
                        <tr>
                            <td>
                                {{__('اسم العميل')}} : <strong>{{$order->customerName}}</strong>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                {{__('تاريخ الطلب')}} : <strong>{{$order->date}}</strong>
                            </td>

                        </tr>
                        <tr>
                            <td>
                                {{__('السعر ')}} : <strong>{{ array_sum($products->pluck('price')->toArray()) }}</strong>
                            </td>
                        </tr>
                            ...
                            @foreach($products as $product)
                                <tr id="removable{{$product->id}}">
                                    ...
                                    <td>{{$product->quantity}}</td>
                                                                       ...
                                                                       <td class="text-center">{{$product->colorName}}</td>
