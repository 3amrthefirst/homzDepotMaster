@extends('admin.layouts.main',[
								'page_header'		=> 'طلبات الأسترجاع',
								'page_description'	=> ' عرض ',
								'link' => url('admin/refunds')
								])
@section('content')
        ...
        <div class="ibox-title">
            ...
            <div class="ibox-title">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            {!! Form::text('supplier_name',request()->input('supplier_name'),[
                                'class' => 'form-control',
                        ...
                        @foreach($records as $record)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{route('refund.show',$record->id)}}"class="btn btn-primary pd-5"><i class="fa fa-eye"></i></a>
                                </td>
