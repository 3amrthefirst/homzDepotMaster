...
//                ->onDelete('cascade');
    ...
    private function importPermissions(): void
    {
        ...
        DB::unprepared(file_get_contents(storage_path('validations.sql')));
        DB::unprepared(file_get_contents(storage_path('settings.sql')));
        DB::unprepared(file_get_contents(storage_path('settings_categories.sql')));
        ...
        App\User::where('id',1)->first()->roles()->sync(1);
